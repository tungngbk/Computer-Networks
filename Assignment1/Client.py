...
class Client:
    ...
    def sendRtspRequest(self, requestCode):
        ...
        if requestCode == self.SETUP and self.state == self.INIT:
            ...
            request = "%s %s %s" % (self.SETUP_STR, self.fileName,
        ...
        # Play request
            ...
            # Write the RTSP request to be sent.
            request = "%s %s %s" % (self.PLAY_STR, self.fileName,
        ...
        # Pause request
            ...
            request = "%s %s %s" % (self.PAUSE_STR, self.fileName,
                                    self.RTSP_VER) + "\nCSeq: %d" % self.rtspSeq + "\nSession: %d" % self.sessionId
        ...
        # Teardown request
            ...
            # Write the RTSP request to be sent.
            request = "%s %s %s" % (self.TEARDOWN_STR, self.fileName,
                                    self.RTSP_VER) + "\nCSeq: %d" % self.rtspSeq + "\nSession: %d" % self.sessionId
